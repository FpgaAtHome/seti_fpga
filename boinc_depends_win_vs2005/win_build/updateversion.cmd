...
rem Increment the revision number and then save the new version number.
...
SET /A BUILDVERSIONREVISION+=1

CALL setversion.cmd %BUILDVERSIONMAJOR%.%BUILDVERSIONMINOR%.%BUILDVERSIONREVISION%
