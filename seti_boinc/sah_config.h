...
#define COMPILER_STRING "g++ (GCC) 4.4.7 20120313 (Red Hat 4.4.7-4)"
...
/* Define to 1 if the system has the type `jmp_buf'. */
#define HAVE_JMP_BUF 1

/* Define to 1 if you have the cpufeatures library */
/* #undef HAVE_LIBCPUFEATURES */
...
/* Define to 1 if you have the <machine/cpu-features.h> header file. */
/* #undef HAVE_MACHINE_CPU_FEATURES_H */
...
/* Define to 1 if you have the <mmap.h> header file. */
/* #undef HAVE_MMAP_H */
...
/* Define to 1 if you have the <sys/cpu-features.h> header file. */
/* #undef HAVE_SYS_CPU_FEATURES_H */
...
/* Define to 1 if the system has the type `_m256'. */
/* #undef HAVE__M256 */

/* Define to 1 if the system has the type `_m256d'. */
/* #undef HAVE__M256D */

/* Define to 1 if the system has the type `_m256i'. */
/* #undef HAVE__M256I */
...
/* Define to 1 if the system has the type `__m256'. */
#define HAVE___M256 1

/* Define to 1 if the system has the type `__m256d'. */
#define HAVE___M256D 1

/* Define to 1 if the system has the type `__m256i'. */
#define HAVE___M256I 1
...
#define PACKAGE_STRING "setiathome_v7 7.28"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "setiathome_v7"

/* Define to the version of this package. */
#define PACKAGE_VERSION "7.28"
...
/* Define to 1 to enable neon instructions on ARM devices */
#define USE_NEON 1
